function params = initializeParameters(groupe)
    ...
    params.position_threshold_percent = 40; % Seuil de déplacement significatif (% du déplacement max)
    ...
    % Chemin de base pour les fichiers selon le groupe
    if groupe == 1
        params.base_path = 'C:\\Users\\Francalanci Hugo\\Documents\\MATLAB\\Stage Sainte-Justine\\HUG\\Sujets\\Asymptomatic';
    elseif groupe == 2
        params.base_path = 'C:\\Users\\Francalanci Hugo\\Documents\\MATLAB\\Stage Sainte-Justine\\HUG\\Sujets\\Pre_operation';
    elseif groupe == 3
        params.base_path = 'C:\\Users\\Francalanci Hugo\\Documents\\MATLAB\\Stage Sainte-Justine\\HUG\\Sujets\\Post_operation';
    end
end