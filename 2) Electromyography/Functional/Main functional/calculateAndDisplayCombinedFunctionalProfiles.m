function calculateAndDisplayCombinedFunctionalProfiles(time_normalized, all_functional_data_R, all_functional_data_L, muscles_R, muscles_L, functional_labels, nb_subjects, nb_muscles)
    % Cette fonction calcule et affiche les profils EMG moyens en combinant les 4 mouvements fonctionnels
    % 
    % Paramètres:
    ...
    %   functional_labels - Étiquettes des mouvements fonctionnels
