...
%
% function 
%   [W,H,i]=nmfanls_comb(A,k,verbose,bi_conv,eps_conv)
%           Changé en NMF i.e. non négative matrix factorisation
%
% input parameters:
%   A: m x n data matrix (m: features, n: data points)
...
%
%
function [W,H,i]= NMF(A,k,verbose,bi_conv,eps_conv)

if nargin<5, eps_conv=1e-4; end
if nargin<4, bi_conv=[0 10]; end
